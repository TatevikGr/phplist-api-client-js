...
/**
 * Request class for creating a new campaign.
 */
export class CreateCampaignRequest extends AbstractRequest {
  /**
   * @param {Object} content - The content of the campaign (subject, body)
   ...
   */
  constructor(content, format = null, metadata = null, schedule = null, options = null) {
    super();
